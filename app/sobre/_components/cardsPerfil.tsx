  ...
  return (
    <div className="flex h-auto w-full max-w-7xl flex-col items-start justify-start md:h-2/3">
      ...
      <div className="flex w-full flex-col gap-4 md:flex-row md:gap-6">
        ...
        <div className="group bg-background relative flex h-full w-full flex-col overflow-hidden border border-dashed border-black/40 p-4 shadow-xl shadow-black/10 transition-all duration-300 hover:shadow-2xl md:w-1/3 md:p-6">
