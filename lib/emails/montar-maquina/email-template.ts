                ...
                <table role="presentation" width="100%">
                  <tr>
                    <td class="content">
                      ...
                      <h2 class="section-title">Produto e Embalagem</h2>
                      <div class="info">
                        <span class="label">Tipo de Produto</span
                        ><span class="value">{{produto}}</span>
                      </div>
                      <div class="info">
                        <span class="label">Tipo de Embalagem</span
                        ><span class="value">{{embalagem}}</span>
                      </div>

                      {{#if detalhes}}
                      <h2 class="section-title">Detalhes da Solicitação</h2>
                      <div class="info">
                        <span class="value">{{detalhes}}</span>
                      </div>
                      {{/if}}
                    </td>
                  </tr>
